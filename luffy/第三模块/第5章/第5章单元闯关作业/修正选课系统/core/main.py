...
#             while True:
#                 try:
#                     stu_score_object = pickle.upload(f)
...
#                 try:
#
#                     stu_score_object = pickle.upload(f)#每次反序列化一个对象
